...
static const char *payload_text =
  ...
  "Date: Thu, 22 Sep 2022 00:36:29 +0300\r\n"
  "To: " TO_MAIL "\r\n"
  "From: " FROM_MAIL "\r\n"
  "Cc: " CC_MAIL "\r\n"
  "Message-ID: <dcd7cb36-11db-487a-9f3a-e652b9458ef01@"
  "rfcpedant.example.org>\r\n"
  "Subject: Viesti kullalle 4\r\n"
  "\r\n" // empty line to divide headers from body, see RFC5322
  "ÄÖÅäöå€: LOVE YOU BABY!\r\n"
  "\r\n";
*/
...
int nolongermain(void)
{
  ...
  if(curl) {
    ...
    curl_easy_setopt(curl, CURLOPT_USERNAME, "esa.kettunen@gmx.com");
    curl_easy_setopt(curl, CURLOPT_PASSWORD, "H3m3nd3xGMX");

    /* This is the URL for your mailserver. Note the use of smtps:// rather
     * than smtp:// to request a SSL based connection. */
    curl_easy_setopt(curl, CURLOPT_URL, "smtps://mail.gmx.com");
